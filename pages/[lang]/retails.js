...
const Retails = () => {
    return (
        <div className="page_layout">
            <SideBar activeMenu={{act:'active',menu:'project'}} langEn='retails_en' langId='retails_id'/>
            <motion.div className="page_layout-main"  initial='initial' animate='animate' exit="exit">
                <div className="page_project">
                    ...
                    <TabProject activeMenu={{act:'active',menu:'retails'}}/>
                </div>
            </motion.div>
        </div>
    )
...
export default withLocale(Retails)
