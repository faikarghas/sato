...
const Retails = () => {
    ...
    return (
        <div className="page_layout">
            ...
            <Menu activeMenu={{act:'active',menu:'retails'}} langEn='retails' langId='retails' thisproject="thisproject"/>
            <motion.div className="page_layout-main"  initial='initial' animate='animate' exit="exit">
                <div className="page_project">
                    ...
                    <TabProject className="hide-mobile" activeMenu={{act:'active',menu:'retails'}}/>
