...
const ShowUnits = () => {
    ...
    return (
        <div className="page_layout">
            ...
            <Menu activeMenu={{act:'active',menu:'units'}} langEn='show-units' langId='show-units' thisproject="thisproject"/>
            <motion.div className="page_layout-main"  initial='initial' animate='animate' exit="exit">
                <div className="page_project">
                    ...
                    <TabProject className="hide-mobile" activeMenu={{act:'active',menu:'units'}}/>
